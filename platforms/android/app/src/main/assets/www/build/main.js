...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__feedback_feedback__ = __webpack_require__(99);
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/mac/CarparkFinder/src/pages/home/home.html"*/'<!--Navigation Bar-->\n<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Home</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<!--Home Body-->\n<ion-content padding class="backgroundColor">\n  <br/>\n    <div class="row" style="text-align:center">\n        <div class="col"><img src="assets/imgs/earth-globe.png" alt="img" style="width:55%;height:80%"></div>\n      </div>\n      <div class="row">\n          <div class="col"></div>\n          <div class="col"><h3 class="fontColor">Welcome!</h3></div>\n      </div>\n      <br/>\n      <button ion-button full class="buttonColor">Search Location</button>\n      <br/>\n      <button ion-button full class="buttonColor">Near By You</button>\n      <br/>\n      <button ion-button full class="buttonColor2" (click)="RedirectToFeedBackPage()">Feedback Us</button>\n</ion-content>\n'/*ion-inline-end:"/Users/mac/CarparkFinder/src/pages/home/home.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"/Users/mac/CarparkFinder/src/pages/list/list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/mac/CarparkFinder/src/pages/list/list.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_feedback_feedback__ = __webpack_require__(99);
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        this.pages = [
            ...
            { title: 'Feedback', component: __WEBPACK_IMPORTED_MODULE_6__pages_feedback_feedback__["a" /* FeedbackPage */] }
        ];
    }
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/mac/CarparkFinder/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/Users/mac/CarparkFinder/src/app/app.html"*/
        }),
